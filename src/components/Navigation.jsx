  ...
  return (
    <nav className="topbar" aria-label="Primary navigation">
      ...
      <div className="social-links">
        <a href="https://github.com/" target="_blank" rel="noreferrer"><SocialIcon type="github" /><span>GitHub</span></a>
        <a href="https://linkedin.com/" target="_blank" rel="noreferrer"><SocialIcon type="linkedin" /><span>LinkedIn</span></a>
        <a href="mailto:hello@example.com"><SocialIcon type="email" /><span>Email</span></a>
